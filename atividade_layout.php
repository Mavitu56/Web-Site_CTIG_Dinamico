...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(count($arquivos['name'])==3){
      ...
      $assunto=[
        ...
        "image1"=> $arquivos['name'][1],
        "image2"=> $arquivos['name'][2],
        "image3"=> $arquivos['name'][3],
        "image4"=> null,
        "image5"=> null,
        "image6"=> null
    ];
    }elseif(($arquivos['name'])==5){
      $assunto=[
        "titulo" => $titulo,
        "texto" => $conteudo,
        "image0"=> $arquivos['name'][0],
        ...
        "image2"=> $arquivos['name'][2],
        "image3"=> $arquivos['name'][3],
        "image4"=> $arquivos['name'][4],
        "image5"=> null,
        "image6"=> null
    ];
    }elseif(($arquivos['name'])==6){
      $assunto=[
        "image0"=> $arquivos['name'][0],
        "image1"=> $arquivos['name'][1],
        "image2"=> $arquivos['name'][2],
    ...
    <!DOCTYPE html>
        ...
        <?php require_once "header.php" ?>
              <div class="container nav-pad" id="main-content">
                ...
                <div class="text-news">
                <pre style="font-family:'. 'Advent Pro' . ', sans-serif;"><?php echo $data->texto; ?></pre>
                </div>
                <div class="xs-only">
                  ...
                  <div data-animate-show class="nuvem img-fluid">
                    ...
                    <div id="panel" class="row">
                        ...
                        <?php if($data->image3==null){
                          ...
                          echo "
                          <div data-animate-about-right class='.'col-6 lazyload'.'><img class='.'img-fluid'.' src='.'img/<?php echo ".$data->image3."; ?>'.'></div>";
                        }
                        ?>
                      </div>
                    </div>
                ...
                <div class="container">
                  <div class="xs-only">
                    ...
                    <?php if($data->image4==null){
                      ...
                      echo "
                      <div data-animate-about-right class='.'col-6 lazyload'.'><img class='.'img-fluid'.' src='.'img/<?php echo ".$data->image4."; ?>'.'></div>";
                    }
                    ?>
                    <?php if($data->image5==null){

                    }else{
                      echo "
                      <div data-animate-about-right class='.'col-6 lazyload'.'><img class='.'img-fluid'.' src='.'img/<?php echo ".$data->image5."; ?>'.'></div>";
                    }
                    ?>
                      </div>
                    </div>
                    <div class="big-frame">
                    <div id="panel-empty" class="row">       
                    <?php if($data->image6==null){

                    }else{
                      echo "
                      <div data-animate-about-right class='.'col-6 lazyload'.'><img class='.'img-fluid'.' src='.'img/<?php echo ".$data->image6."; ?>'.'></div>";
                    }
                    ?>
                      </div>
                    </div>
    ...
    $header="<?php 
      ...
      <div class='.'lazyload'.' id='.'feed'.'><a href='.'".$sem.".php'.'><img id='.'feed-img'.' class='.'img-fluid'.' src='.'img/'.$".$sem."_data->image0.'></a></div>
      <h2>'.$".$sem."_data->titulo.'</h2>
      </div>';
      ?>";
    $seletor=$_POST["seletor"];
    if($seletor=="1"){
      file_put_contents("index_feed.php",$feed, FILE_APPEND);
    }elseif($seletor==2){
      file_put_contents("index_feed2.php",$feed, FILE_APPEND);
    }elseif($seletor==3){
      file_put_contents("index_feed3.php",$feed, FILE_APPEND);
    }elseif($seletor==4){
      file_put_contents("index_feed4.php",$feed, FILE_APPEND);
    }else{
        ...
        <form method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF'];?>">
            <div class="mb-3">
              ...
              <div class="input-group mb-3">
                <label class="form-label"><h1>Conteúdo de texto</h1></label>
                <textarea name="text" class="form-controled" aria-label="With textarea"></textarea>
              </div>
              <div class="mb-3">
                <label class="form-label" for=""><h1>Escolha de 3 a 7 imagens:</h1></label>
              ...
              <select name="seletor" id="page-select" class="form-select" aria-label="Página">
                <option selected>Escolha a fileira do feed em que a notícia ficará:</option>
                <option id="1" value="1">Primeira</option>
                <option id="2" value="2">Segunda</option>
                <option id="3" value="3">Terceira</option>
                <option id="4" value="4">Quarta</option>
                <option id="nenhuma" value="nenhuma">Nenhuma</option>
              </select>
              ...
              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                elseif(file_put_contents("atividade_link.php",$header, FILE_APPEND)==false){
                  echo "Erro ao criar ao página";
                }else{
